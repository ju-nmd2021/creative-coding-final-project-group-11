...
function setup() {
  ...
  noStroke();
  shapes = ["half-ellipse-left", "ellipse", "rectangle"];
  ...
  for (let i = 0; i < 4; i += 1) {
    for (let l = 0; l < 7; l += 1) {
      ...
      if (randomShape == "ellipse") {
        ellipse(70 + 60 * i, 40 + 50 * l, random(30, 40));
      }
      if (randomShape == "rectangle") {
        rect(50 + 60 * i, 40 + 50 * l, random(30, 40), random(20, 40));
      }
      if(randomShape =="half-ellipse-left"){
        let startAngle = HALF_PI;
        let endAngle = -HALF_PI;
        arc(50+60*i, 40 + 50 * l, 30, 30, startAngle, endAngle, PIE);
      }
    }
  }
  fill(0);
